...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PRABATH-MD~tqMAhDJK#8Bofp_YpjFv2FBdQ6aVBaa5iG07O9-etgbhakEotafs' : process.env.SESSION_ID,
...
HEART_REACT: process.env.HEART_REACT || 'false',
    SUDO: process.env.SUDO === undefined ? '9473737373,94762095304' : process.env.SUDO,
